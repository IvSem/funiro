(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".slider-rooms")) new swiper_core_Swiper(".slider-rooms", {
                modules: [ Navigation, Autoplay, Pagination, freeMode, Parallax ],
                slidesPerView: "auto",
                spaceBetween: 24,
                parallax: true,
                loop: true,
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                ...
                if (window.innerWidth > 768 && isMobile.any()) {
                    ...
                    if (!targetElement.closest(".menu__item") && document.querySelectorAll(".menu__item._hover")) removeClasses(document.querySelectorAll(".menu__item._hover"), "_hover");
                }
            ...
            const addToCart = (productsButton, productId) => {
                if (!productsButton.classList.contains("_hold")) {
                    ...
                    productImageFly.addEventListener("transitionend", (() => {
                        if (productsButton.classList.contains("_fly")) {
                            ...
                            updateCart(productsButton, productId);
                            productsButton.classList.remove("_fly");
                        }
                    }));
                }
            };
            const updateCart = (productsButton, productId, productAdd = true) => {
